...
/* 
 * It seems that struct bus_type has changed a lot.
 * Gone: hotplug
 * New:  uevent, probe, remove, suspend_late, resume_early, shutdown
 * I've only put in the uevent handler, since it is not clear to me
 * what functionality an "ldd" device should provide for the others. 
 */
