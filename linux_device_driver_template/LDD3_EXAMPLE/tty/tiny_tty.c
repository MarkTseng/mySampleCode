...
static int __init tiny_init(void)
{
	 ...
	 * structure above... */
	//tiny_tty_driver->ops.read_proc = tiny_read_proc;
	//tiny_tty_driver->ops.tiocmget = tiny_tiocmget;
	//tiny_tty_driver->ops.tiocmset = tiny_tiocmset;
	//tiny_tty_driver->ops.ioctl = tiny_ioctl;
