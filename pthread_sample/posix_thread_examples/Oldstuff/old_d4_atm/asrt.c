...
void process_request(workorder_t *);
...
void atm_server_init(int argc, char **argv)
{
  ...
  pthread_cond_init(&pthread_info.thread_exit_cv, pthread_condattr_default);
  pthread_mutex_init(&pthread_info.mutex, pthread_mutexattr_default);
