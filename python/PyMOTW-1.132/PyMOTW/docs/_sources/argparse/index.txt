...
::
	...
	Namespace(f=None, file=<open file 'argparse_type.py', mode 'r' at 0x1004486f0>, i=None)
...
::
	...
	usage: argparse_FileType.py [-h] [-i in-file] [-o out-file]
	argparse_FileType.py: error: [Errno 2] No such file or directory: 'no_such_file.txt'
